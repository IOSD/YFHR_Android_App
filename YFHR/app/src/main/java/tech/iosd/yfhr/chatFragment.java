...
View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        HamButton.Builder builder1 = new HamButton.Builder()
                ...
                .subNormalTextRes(R.string.opt1_detail).normalColorRes(R.color.headerColor).listener(new OnBMClickListener() {
                    @Override
        ...
        HamButton.Builder builder2 = new HamButton.Builder()
                ...
                .subNormalTextRes(R.string.opt2_detail).normalColorRes(R.color.colorAccent).listener(new OnBMClickListener() {
                    @Override
                    public void onBoomButtonClick(int index) {
